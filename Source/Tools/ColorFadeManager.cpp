...
sf::Color ColorFadeManager::getCurrentColor() {
    ...
    r = elapsedTime * (m_target_color.r - m_start_color.r) / m_duration.asMilliseconds() +
        m_start_color.r;
    g = elapsedTime * (m_target_color.g - m_start_color.g) / m_duration.asMilliseconds() +
        m_start_color.g;
    b = elapsedTime * (m_target_color.b - m_start_color.b) / m_duration.asMilliseconds() +
        m_start_color.b;
